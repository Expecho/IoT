    ...
    sp.on("data", function (data) {
      ...
      if (startCharPos >= 0 && endCharPos >= 0) {
        ...
        if (parsedPacket.timestamp !== null) {
          ...
          var mqttMsg = createMQTTMessage(parsedPacket);
          mqttClient.publish("sensor/p1", mqttMsg);
...
function createDeviceToCloudMessage(parsedPacket) {
  var gasActual = 0;
...
function createMQTTMessage(parsedPacket) {
  var gasActual = 0;
