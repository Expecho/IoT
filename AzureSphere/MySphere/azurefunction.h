...
static void Send(char* sensor, double value)
{
   ...
   if (curl) {
      /* First set the URL that is about to receive our POST. This URL can
         ...
         data. */
      curl_easy_setopt(curl, CURLOPT_URL, "http://iotdemo-expecho.azurewebsites.net/api/AzureSphereTrigger?code=bTIKhvqdZxTSlx9AaMrgsupk65/fCUFCqU5umRv2LFzDLsJFjC/0tw==");
